...
let n = 0;
let op = prompt(
  "Ingresa por favor \n 1 para iniciar o volver a ingresar un departamento \n 5 para salir"
);

while (op === "1" && op !== "5") {
  let departamento = prompt("Ingresa por favor un departamento o escribe 5 para salir");
  ...
  if (n === 0) {
    ...
    while (
      ...
      departamento = prompt(
        "Ingresa por favor un departamento valido o escribe 5 para salir"
      );
    }
